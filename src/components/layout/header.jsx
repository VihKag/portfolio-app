          ...
          {session ? (
            <>
              {username && (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-muted-foreground hover:text-accent gap-1.5 h-9"
                >
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="hover:text-accent gap-1.5 h-9"
              >
                <Link to="/dashboard">
            ...
            <>
              ...
              <Button
                asChild
                size="sm"
                className="bg-accent hover:bg-accent/90 text-accent-foreground glow-accent-sm font-semibold h-9 ml-1"
              >
