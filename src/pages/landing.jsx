        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Button
              asChild
              size="lg"
              className="bg-accent hover:bg-accent/90 text-accent-foreground glow-accent font-semibold px-8 h-12"
            >
              <Link to="/auth/signup">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-border/50 hover:border-accent/50 hover:text-accent bg-transparent h-12"
            >
